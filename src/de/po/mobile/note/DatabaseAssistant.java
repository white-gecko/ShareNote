...
// the following code is from http://mgmblog.com/2009/02/06/export-an-android-sqlite-db-to-an-xml-file-on-the-sd-card/
// and adopted by me
public class DatabaseAssistant {
	...
	class Exporter {
		...
		public Exporter(String fileName) throws FileNotFoundException {
			this(new BufferedOutputStream(_ctx.openFileOutput(fileName,
